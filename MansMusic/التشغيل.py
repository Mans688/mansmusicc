...
from MusicM_8_S_H7.helpers.queues import QUEUE, add_to_queue, get_queue
...
from MusicM_8_S_H7.helpers.merrors import capture_err
    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://telegra.ph/file/5c434e6479b5d0428a743.jpg",
                    caption=f"""
**🏷️ العنوان : [{songname}]({link})
💬 ايدي الدردشة : {chat_id}
🎧 طلب من : {m.from_user.mention}
💻 قناة السورس : [ قناة السورس ](t.me/M_8_S_H7)**
""",
                )
            else:
