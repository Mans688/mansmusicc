...
async def restart(client, m: Message):
    await m.delete()
    M_8_S_H7 = await m.reply("1")
    await M_8_S_H7.edit("2")
    await M_8_S_H7.edit("3")
    await M_8_S_H7.edit("4")
    await M_8_S_H7.edit("5")
    await M_8_S_H7.edit("6")
    await M_8_S_H7.edit("7")
    await M_8_S_H7.edit("8")
    await M_8_S_H7.edit("9")
    await M_8_S_H7.edit("**تم اعادة تشغيل سورس ابن الدورة ميوزك بنجاح ✓**")
